...
Go{
  ...
  ITEMBUILD{
    ...
    {I_CORE,
      'soul_ring', 'magic_wand', 'boots'},
    {I_LUXURY,
      'ultimate_scepter', 'necronomicon', {ALT, 'arcane_boots', 'travel_boots'}, 'vladmir', 'pipe'},
  },
...
Go{
  ...
  ITEMBUILD{ name="Alternate Items",
    ...
    {I_LUXURY,
      'diffusal_blade', 'heart', 'butterfly', 'manta', 'greater_crit', 'travel_boots' },
  },
...
Go{
  ...
  ITEMBUILD{ name="Hard Lane Items",
    ...
    {I_CORE,
      'poor_mans_shield', {OPT, 'bottle'}, 'phase_boots', 'ancient_janggo',},
    {I_LUXURY,
      'black_king_bar', 'desolator', 'monkey_king_bar', 'butterfly', 'medallion_of_courage'},
  },
  ...
  ITEMBUILD{ name="Safe Lane Items",
    {I_STARTING,
      {3, 'branches'}, 'stout_shield', 'flask', 'tango' },
    {I_CORE,
      'poor_mans_shield', 'phase_boots', 'ancient_janggo', 'desolator'},
    {I_LUXURY,
      'black_king_bar', 'monkey_king_bar', 'butterfly', 'medallion_of_courage' },
  },
...
Go{
  ...
  ITEMBUILD{
    ...
    {I_LUXURY,
      'vitality_booster', 'pipe', 'force_staff', 'ultimate_scepter'},
    {I_OPTIONAL,
...
Go{
  ...
  ITEMBUILD{
    ...
    {I_CORE,
      'tranquil_boots', 'mekansm', 'ultimate_scepter'},
    {I_LUXURY,
      'travel_boots', 'heart', 'pipe', 'vladmir', 'assault' },
    {I_OPTIONAL,
      'blink' },
  },
...
Go{
  ...
  ITEMBUILD{
    {I_STARTING,
      'stout_shield', {3, 'branches'}, 'flask', 'tango' },
    {I_CORE,
      'magic_wand', 'poor_mans_shield', 'power_treads', 'vitality_booster' },
    {I_LUXURY,
